...
- 应用导航、Workflow 管理、Agent 任务中心、长期记忆管理、Provider 管理、Agent Profile 管理、Agent Skill 管理、会话主界面和提示词设置已分别拥有独立 UI 垂直边界；下一轮从宿主剩余 `1,582` 行重新盘点完整状态/动作簇，而不是继续扩张 Agent Runtime 或设备权限。
