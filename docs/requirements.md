...
这里的 `swipe` “继续关闭”仅指生产 Workflow 默认集合：第 125 阶段已经完成其答案级脱敏 Decision、Room/Workflow output 与 UI 投影，且不会持久化方向、viewport/HMAC、snapshot/ref、节点正文或坐标。生产接线和 Redmi 真实生产 Workflow 验收仍作为下一独立阶段。
